...
public class DialogPlus {
    ...
    DialogPlus(DialogPlusBuilder builder) {
        ...
        initContentView(
                ...
                builder.getAdapter(),
                builder.getRecyclerAdapter(),
                builder.getLayoutManager(),
     ...
     * Creates a new dialog builder
     */
    public static DialogPlusBuilder newDialog(@NonNull Context context, Holder holder) {
        return new DialogPlusBuilder(context).setContentHolder(holder);
    }
    ...
    private void initExpandAnimator(Activity activity, int defaultHeight, int gravity) {
        ...
        if (view instanceof RecyclerView) {
            ...
            view.setOnTouchListener(RecyclerExpandTouchListener.newListener(
                    activity, recyclerView, contentContainer, gravity, displayHeight, defaultHeight
            ));
            return;
        }
    ...
    private void initContentView(LayoutInflater inflater, View header, boolean fixedHeader, View footer,
                                 boolean fixedFooter, BaseAdapter adapter, RecyclerView.Adapter recyclerAdapter, RecyclerView.LayoutManager layoutManager, int[] padding, int[] margin) {
        View contentView= createView(inflater, header, fixedHeader, footer, fixedFooter, adapter, recyclerAdapter, layoutManager);
    ...
    private View createView(LayoutInflater inflater, @Nullable View headerView, boolean fixedHeader,
                            @Nullable View footerView, boolean fixedFooter, BaseAdapter adapter, RecyclerView.Adapter reclclerAdapter, RecyclerView.LayoutManager layoutManager) {
        ...
        if ((adapter!=null||reclclerAdapter!=null) && holder instanceof HolderAdapter) {
            HolderAdapter holderAdapter = (HolderAdapter) holder;
            holderAdapter.setAdapter(adapter,reclclerAdapter);
