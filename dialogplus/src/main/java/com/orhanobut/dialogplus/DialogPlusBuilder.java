...
public class DialogPlusBuilder {
    ...
    private RecyclerView.Adapter recycleraAapter;
    ...
    public DialogPlusBuilder setRecyclerAdapter(@NonNull RecyclerView.Adapter adapter) {
        this.recycleraAapter = adapter;
        return this;
    }

    public DialogPlusBuilder setLayoutManager(@NonNull RecyclerView.LayoutManager layoutManager) {
